...
function canWeDeliver(zipCode) {
    if (deliveryAreaZipCodes.includes(zipCode)) {
        return "You are within our delivery zone!"
    } else {
...
console.log(canWeDeliver(87777))
...
/* 
    ...
    loop (for loop, higher order rray method).
    Name your new function `canWeDeliverTwo`.
*/

function canWeDeliverTwo(zipCode) {
    let currentZip = false
...
console.log(canWeDeliverTwo(87777))
