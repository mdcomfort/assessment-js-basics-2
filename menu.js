...
const foodArr = [
    ...
    },
    {
        ...
        popularity: 6,
        rating: 5,
        tags: ['veggie', 'veggies', 'vegetarian']
    }
]
...
function filterByProperty(property, number, type) {
    const filteredArray = foodArr.filter(function(food) {
        if (type === 'above') {
